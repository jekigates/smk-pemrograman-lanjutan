...
<body>
      ...
      <div class="col-12">
        <div class="table-responsive">
          <table class="table table-striped align-middle">
            ...
            <tbody>
              <?php
              $sql1 = "SELECT *, tbmapel.id_mapel AS id_mapel, tbmapel.id_jurusan AS id_jurusan, tbmapel.id_guru AS id_guru FROM tbmapel LEFT JOIN tbjurusan ON tbmapel.id_jurusan = tbjurusan.id_jurusan LEFT JOIN tbguru ON tbmapel.id_guru = tbguru.id_guru LEFT JOIN tbpengguna ON tbguru.id_guru = tbpengguna.id_pengguna";
              ($query1 = mysqli_query($conn, $sql1)) or die("error: " . $sql1);
              $iteration = 1;
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex gap-2">
                    <button class="btn btn-info" type="button" onclick="editForm(<?php echo "'$id_mapel', '$nama_mapel', '$id_jurusan', '$id_pengguna'"; ?>)">Edit</button>
  ...
  <script>
    function editForm(id_mapel, nama_mapel, id_jurusan, id_pengguna) {
      this.id_mapel.value = id_mapel;
      this.nama_mapel.value = nama_mapel;
