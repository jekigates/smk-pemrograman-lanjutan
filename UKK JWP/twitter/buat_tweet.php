  ...
  <div class="container-fluid p-4">
    <div class="row">
      <div class="col-4 offset-4">
        <form action="./crud.php?cmd=posts_create" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
          <div class="form-group mb-4">
            <label for="foto" class="form-label">Foto Postingan</label>
            <img class="w-100 bg-light border border-primary" style="height: 30rem;" id="divFoto"></img>
          ...
          <div class="mb-4">
            ...
            <textarea class="form-control" name="deskripsi" id="deskripsi" rows="4" placeholder="Deskripsi" required maxlength="250"></textarea>
            <div class="invalid-feedback">
              Deskripsi perlu diisi.
            </div>
          </div>
          <div class="d-grid gap-2">
            <button class="btn btn-primary" type="submit">Buat Tweet</button>
          </div>
        </form>
      </div>
    </div>
